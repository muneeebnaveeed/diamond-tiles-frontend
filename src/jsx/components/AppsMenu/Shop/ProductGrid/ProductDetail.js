...
const ProductDetail = ({ match }) => {
   ...
   const { previewImg, rating, price, availability, productCode, brand, tags, des, imageList } = singleProductData;
                                 ...
                                 {imageList.map((images, i) => (
                                    <li role="presentation" className="show" key={i}>
                                       <Link to="#first" role="tab" data-toggle="tab">
                                          <img className="img-fluid" src={images} alt="" width="50" />
                                       </Link>
                                    </li>
                                 ))}
                              </ul>
                           ...
                           <div className="product-detail-content">
                              <div className="new-arrival-content pr">
                                 ...
                                 <div className="star-rating mb-2 d-flex">
                                    {rating} <span className="review-text"> (34 reviews) / </span>
                                    <Link className="product-review" to="/ecom-product-detail">
                                       {' '}
                                       Write a review?
                                    </Link>
                                 </div>
                                 ...
                                 <p>
                                    Availability:{' '}
                                    <span className="item">
                                       {availability} <i className="fa fa-shopping-basket" />
                                    </span>
                                 </p>
                                 <p>
                                 ...
                                 <p>
                                    Product tags:&nbsp;&nbsp;
                                    {tags.map((tag, i) => (
                                       <span className="badge badge-success light mr-1" key={i}>
                                          {tag}
                                       </span>
                                    ))}
                                 </p>
