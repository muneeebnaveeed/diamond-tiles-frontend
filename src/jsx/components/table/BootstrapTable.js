                     ...
                     <Table responsive>
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td>
                                 <div className="d-flex align-items-center">
                                    <i className="fa fa-circle text-success mr-1" /> Successful
                                 </div>
                              </td>
                              <td>
                                 <div className="d-flex">
                                    <Link href="#" className="btn btn-primary shadow btn-xs sharp mr-1">
                           ...
                           <tr>
                              ...
                              <td>
                                 <div className="d-flex align-items-center">
                                    <i className="fa fa-circle text-danger mr-1" /> Canceled
                                 </div>
                              </td>
                              <td>
                                 <div className="d-flex">
                           ...
                           <tr>
                              ...
                              <td>
                                 <div className="d-flex align-items-center">
                                    <i className="fa fa-circle text-warning mr-1" /> Pending
                                 </div>
                              </td>
                              <td>
                                 <div className="d-flex">
