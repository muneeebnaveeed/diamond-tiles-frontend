            ...
            <Card>
               ...
               <Card.Body>
                  <Card.Text className="mb-3">
                     While Bootstrap u ses or for defining most sizes,are used for grid breakpoints and container
                     widths. This is because the viewport width is in pixels and does not change with the font size. See
                     how aspects of the Bootstrap grid system work across multiple devices with a handy table.
                  </Card.Text>
      ...
      <Row>
         <Col lg={12}>
            <Card>
               ...
               <Card.Body>
                  <Card.Text className="mb-3">
                     Using a single set of grid classes, you can create a default grid system that starts out stacked on
