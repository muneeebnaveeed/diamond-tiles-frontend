                  ...
                  <div className="card-body">
                     <div className="mb-4">
                        ...
                        <p>
                           ...
                           <code>disabled</code> attribute is set) and from remote srouces where the object has
                  ...
                  <div className="card-body">
                     <div className="mb-4">
                        ...
                        <p>
                           ...
                           <code>50%</code> and <code>75%</code> width respectively to support responsive design:
                        </p>
                     </div>
                  ...
                  <div className="card-body">
                     <div className="mb-4">
                        ...
                        <p>
                           ...
                           <code>theme</code> option so you can style Select2 to match the rest of your application.
                        </p>
                     </div>
               ...
               <div className="card">
                  <div className="card-body">
                     <div className="mb-4">
                        ...
                        <p>
                           Select2 comes with AJAX support built in, using jQuery's AJAX methods. In this example, we
                           can search for repositories using GitHub's API:
                        </p>
                     </div>
               ...
               <div className="card">
                  <div className="card-body">
                     <div className="mb-4">
                        ...
                        <p>
                           You may use the <code>data</code> configuration option to load dropdown options from a local
                           array.
                        </p>
                     </div>
               ...
               <div className="card">
                  <div className="card-body">
                     <div className="mb-4">
                        ...
                        <p>
                           Select2 can be configured to automatically select the currently highlighted result when the
                           dropdown is closed by using the <code>selectOnClose</code>
                           option:
                        </p>
                     </div>
               ...
               <div className="card">
                  <div className="card-body">
                     <div className="mb-4">
                        ...
                        <p>
                           Select2 will automatically close the dropdown when an element is selected, similar to what is
                           done with a normal select box. You may use the
                           <code>closeOnSelect</code> option to prevent the dropdown from closing when a result is
                           selected:
                        </p>
                     </div>
               ...
               <div className="card">
                  <div className="card-body">
                     <div className="mb-4">
                        ...
                        <p>
                           The <code>dropdownParent</code> option allows you to pick an alternative element for the
                           dropdown to be appended to:
                        </p>
                     </div>
               ...
               <div className="card">
                  <div className="card-body">
                     <div className="mb-4">
                        ...
                        <p>
                           In addition to a prepopulated menu of options, Select2 can dynamically create new options
               ...
               <div className="card">
                  <div className="card-body">
                     <div className="mb-4">
                        ...
                        <p>
                           Tagging can also be used in multi-value select boxes. In the example below, we set the
                  ...
                  <div className="card-body">
                     <div className="mb-4">
                        ...
                        <p>
                           ...
                           <code>placeholder</code> option can be a data object representing a default selection (
               ...
               <div className="card">
                  <div className="card-body">
                     <div className="mb-4">
                        ...
                        <p>
                           When users filter down the results by entering search terms into the search box, Select2 uses
                           an internal "matcher" to match search terms to results. You may customize the way that
                           Select2 matches search terms by specifying a callback for the <code>matcher</code>
                  ...
                  <div className="card-body">
                     <div className="mb-4">
                        ...
                        <p>
                           ...
                           <code>matcher</code> callback. If you are working with nested data, you must iterate through
                           the
               ...
               <div className="card">
                  <div className="card-body">
                     <div className="mb-4">
                        ...
                        <p>
                           New options can be added to a Select2 control programmatically by creating a new Javascript
               ...
               <div className="card">
                  <div className="card-body">
                     <div className="mb-4">
                        ...
                        <p>
                           You can use <code>.find</code> to select the option if it already exists, and create it
                           otherwise:
                        </p>
                     </div>
                  ...
                  <div className="card-body">
                     <div className="mb-4">
                        ...
                        <p>
                           ...
                           <code>&lt;select&gt;</code>
                           <span className="copy-to-clipboard" title="Copy to clipboard" />
                           or any parents of it. You can also initialize Select2 with the <code>dir: "rtl"</code>
                           <span className="copy-to-clipboard" title="Copy to clipboard" />
                           configuration option.
                        </p>
                     </div>
               ...
               <div className="card">
                  <div className="card-body">
                     <div className="mb-4">
                        ...
                        <p>
                           The <code>destroy</code> method will remove the Select2 widget from the target element. It
                           will revert back to a standard <code>select</code>
                           control:
                        </p>
                     </div>
               ...
               <div className="card">
                  <div className="card-body">
                     <div className="mb-4">
                        ...
                        <p>
                           Select2 will trigger a few different events when different actions are taken using the
                           component, allowing you to add custom hooks and perform actions.
                        </p>
                     </div>
            ...
            <div className="col-xl-6">
               <div className="card">
                  <div className="card-body">
                     ...
                     <button type="button" className="js-programmatic-multi-clear btn btn-primary mb-2 mr-1">
                        Clear
                     </button>
                     <div className="mt-4">
                        <CustomClearIndicator />
