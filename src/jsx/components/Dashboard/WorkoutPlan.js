                           ...
                           <Modal show={addPlan} className="fade">
                              <div className="modal-content">
                                 <Modal.Header>
                                    ...
                                    <Button variant="" onClick={() => setAddPlan(false)} className="close">
                                       <span>×</span>
                                    </Button>
                                 </Modal.Header>
                                 <Modal.Body>
                                    ...
                                    >
                                       <div className="form-group">
                                          <label>Running</label>
                                          <input type="text" className="form-control" placeholder="Km" />
                                       </div>
                                       <div className="form-group">
                                          <label>Cycling</label>
                                          <input type="text" className="form-control" placeholder="Km" />
                                       ...
                                       <div className="form-group">
                                          <label>Yoga</label>
                                          <input type="text" className="form-control" placeholder="hr" />
                                       </div>
                  ...
                  <div className="col-xl-12">
                     <div className="card plan-list">
                        <div className="card-header d-sm-flex d-block pb-0 border-0">
                           ...
                           <Link to="/workout-statistic" className="btn rounded text-black border border-light mr-4">
                              <svg
                                 className="mr-2"
                                 width={25}
                                 height={24}
                        ...
                        <div className="card-body">
                           <div className="d-flex px-3 pt-3 list-row flex-wrap align-items-center mb-2">
                              ...
                              <div className="info mb-3">
                                 ...
                                 <span className="text-danger font-w600">UNFINISHED</span>
                              </div>
                              ...
                              <Link to="/workout-plan" className="btn mb-3 btn-outline-primary rounded mr-3">
                           ...
                           <div className="d-flex px-3 pt-3 list-row flex-wrap align-items-center mb-2">
                              ...
                              <Link to="/workout-plan" className="btn btn-outline-primary rounded mr-3 mb-3">
                                 <i className="las la-caret-right scale-2 mr-3" />
                                 Start Workout
                              </Link>
                              <Dropdown className="dropdown mb-3">
                           ...
                           <div className="d-flex px-3 pt-3 list-row flex-wrap align-items-center mb-2">
                              ...
                              <div className="info mb-3">
                                 ...
                                 <span className="text-warning font-w600">On Progress</span>
                              </div>
                              ...
                              <Link to="/workout-plan" className="mb-3 btn btn-primary rounded mr-3">
                           ...
                           <div className="d-flex px-3 pt-3 list-row flex-wrap align-items-center mb-2">
                              ...
                              <div className="info mb-3">
                                 ...
                                 <span className="text-primary font-w600">FINISHED</span>
