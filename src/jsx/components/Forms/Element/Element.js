                  ...
                  <div className="row">
                     ...
                     <div className="col">
                        <div className="custom-control custom-checkbox mb-3 checkbox-info">
                           ...
                           <label className="custom-control-label" htmlFor="customCheckBox7" />
                        </div>
                     </div>
                     <div className="col">
                        <div className="custom-control custom-checkbox mb-3 checkbox-success check-lg">
                           ...
                           <label className="custom-control-label" htmlFor="customCheckBox8" />
                        </div>
                     </div>
                     <div className="col">
                        <div className="custom-control custom-checkbox mb-3 checkbox-warning check-xl">
                           ...
                           <label className="custom-control-label" htmlFor="customCheckBox9" />
                        </div>
                     </div>
                  </div>
               </div>
                     ...
                     <form onSubmit={(e) => e.preventDefault()}>
                        <div className="form-group">
                           <div className="form-check mb-2">
                              <input type="checkbox" className="form-check-input" id="check1" value="" checked />
