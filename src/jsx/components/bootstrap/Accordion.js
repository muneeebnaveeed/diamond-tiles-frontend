                        ...
                        {defaultAccordion.map((d, i) => (
                           <div className="accordion__item" key={i}>
                              <Accordion.Toggle
                                 as={Card.Text}
                                 eventKey={`${i}`}
                                 className={`accordion__header  ${activeWithoutSpace === i ? '' : 'collapsed'}`}
            ...
            <Col xl="6">
               <Card>
                  <Card.Header className="d-block">
                     ...
                     <Card.Text className="m-0 subtitle">
                        Add <code>accordion-no-gutter accordion-bordered</code> class with <code>accordion</code>
                     </Card.Text>
                  </Card.Header>
                  <Card.Body>
                     <Accordion className="accordion accordion-no-gutter " defaultActiveKey="0">
                        {defaultAccordion.map((d, i) => (
                           <div className="accordion__item" key={i}>
                              ...
                              >
                                 <span className="accordion__header--text">{d.title}</span>
                                 <span className="accordion__header--indicator style_two" />
                              </Accordion.Toggle>
                              <Accordion.Collapse eventKey={`${i}`}>
                                 <div className="accordion__body--text">{d.text}</div>
                              </Accordion.Collapse>
                        ...
                        {defaultAccordion.map((d, i) => (
                           <div className="accordion__item" key={i}>
                              <Accordion.Toggle
                                 ...
                                 onClick={() =>
                                    setActiveIndicatorInLeftPosition(activeIndicatorInLeftPosition === i ? -1 : i)
                                 }
                              >
                                 <span className="accordion__header--text">{d.title}</span>
                                 <span className="accordion__header--indicator" />
                        ...
                        {defaultAccordion.map((d, i) => (
                           <div className="accordion__item" key={i}>
                              <Accordion.Toggle
                                 as={Card.Text}
                                 eventKey={`${i}`}
                                 className={`accordion__header ${activeAccordionWithIcon === i ? '' : 'collapsed'}`}
                                 onClick={() => setActiveAccordionWithIcon(activeAccordionWithIcon === i ? -1 : i)}
                              >
                                 <span className="accordion__header--icon" />
                                 <span className="accordion__header--text">{d.title}</span>
                                 <span className="accordion__header--indicator indicator_bordered" />
                              </Accordion.Toggle>
                              <Accordion.Collapse eventKey={`${i}`}>
                                 <div className="accordion__body--text">{d.text}</div>
                              </Accordion.Collapse>
                        ...
                        {defaultAccordion.map((d, i) => (
                           <div className="accordion__item" key={i}>
                              <Accordion.Toggle
                                 ...
                                 onClick={() => setActiveAccordionHeaderBg(activeAccordionHeaderBg === i ? -1 : i)}
                              >
                                 <span className="accordion__header--icon" />
                                 <span className="accordion__header--text">{d.title}</span>
                                 <span className="accordion__header--indicator" />
                        ...
                        {defaultAccordion.map((d, i) => (
                           <div className="accordion__item" key={i}>
                              <Accordion.Toggle
                                 ...
                                 onClick={() => setActiveAccordionSolidBg(activeAccordionSolidBg === i ? -1 : i)}
                              >
                                 <span className="accordion__header--icon" />
                                 <span className="accordion__header--text">{d.title}</span>
                                 <span className="accordion__header--indicator " />
            ...
            <Col xl="6">
               <Card className="transparent-card">
                  <Card.Header className="d-block">
                     ...
                     <Card.Text className="m-0 subtitle">
                        Add <code>accordion-header-shadow</code> and <code>accordion-rounded</code> class with{' '}
                        <code>accordion</code>
                     </Card.Text>
                  </Card.Header>
                  <Card.Body>
                        ...
                        {defaultAccordion.map((d, i) => (
                           <div className="accordion__item" key={i}>
                              <Accordion.Toggle
                                 ...
                                 onClick={() =>
                                    setActiveaccordionRoundedStylish(activeaccordionRoundedStylish === i ? -1 : i)
                                 }
                              >
                                 <span className="accordion__header--icon" />
                                 <span className="accordion__header--text">{d.title}</span>
                        ...
                        {defaultAccordion.map((d, i) => (
                           <div className="accordion__item" key={i}>
                              <Accordion.Toggle
                                 ...
                                 onClick={() => setActiveAccordionGradient(activeAccordionGradient === i ? -1 : i)}
                              >
                                 <span className="accordion__header--icon" />
                                 <span className="accordion__header--text">{d.title}</span>
                                 <span className="accordion__header--indicator " />
