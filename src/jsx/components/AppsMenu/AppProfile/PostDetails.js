                     ...
                     <div className="card-body">
                        <div className="profile-statistics mb-5">
                           <div className="text-center">
                              ...
                              <div className="mt-4">
                                 <Link to="/post-details" className="btn btn-primary mb-1 mr-1">
                                    Follow
                                 </Link>
                                 <Button
                                    as="a"
                        ...
                        <div className="profile-interest mb-5">
                           ...
                           <SRLWrapper options={options}>
                              <div className="row mt-4 sp4">
                                 ...
                                 <div className="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                    <a href={profile03} className="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                       <img src={profile03} alt="profile" className="img-fluid" />
                                    </a>
                                 </div>
                                 <div className="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                    <a href={profile04} className="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                       <img src={profile04} alt="profile" className="img-fluid" />
                                    </a>
                                 </div>
                              </div>
                        ...
                        <div className="profile-news">
                           ...
                           <div className="media pt-3 pb-3">
                              <img src={profile05} alt="image" className="mr-3 rounded" width={75} />
                           ...
                           <div className="media pt-3 pb-3">
                              <img src={profile06} alt="image" className="mr-3 rounded" width={75} />
                              <div className="media-body">
                                 <h5 className="m-b-5">
                                    <Link to="/post-details" className="text-black">
                                       Collection of textile samples
                           ...
                           <div className="media pt-3 pb-3">
                              <img src={profile07} alt="image" className="mr-3 rounded" width={75} />
                              <div className="media-body">
                                 <h5 className="m-b-5">
                                    <Link to="/post-details" className="text-black">
                                       Collection of textile samples
                  ...
                  <div className="card">
                     <div className="card-body">
                        <div className="post-details">
                           ...
                           <img src={profile08} className="img-fluid mb-3" />
                           <p>
                              A wonderful serenity has take possession of my entire soul like these sweet morning of
                           ...
                           <blockquote>
                              ...
                              industry's standard text ever since the 1500s, when an unknown printer took a galley of
                              type and scrambled it to make a type specimencenturies.
                           </blockquote>
                           <p>
                           ...
                           <div className="comment-respond" id="respond">
                              ...
                              <form className="comment-form" id="commentform" onSubmit={(e) => e.preventDefault()}>
                                 <div className="row">
                                    <div className="col-lg-6">
                                       <div className="form-group">
                                          <label htmlFor="author" className="text-black font-w600">
