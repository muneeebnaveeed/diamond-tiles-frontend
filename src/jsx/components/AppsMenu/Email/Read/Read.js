                  ...
                  <div className="email-left-box generic-width px-0 mb-5">
                     ...
                     <div className="mail-list mt-4">
                        <Link to="/email-read" className="list-group-item active">
                           ...
                           Inbox
                           <span className="badge badge-primary light badge-sm float-right">198</span>
                        </Link>
                           ...
                           <div className="right-box-padding">
                              ...
                              <div className="read-content">
                                 ...
                                 <div className="read-content-body">
                                    ...
                                    <p className="mb-2">
                                       <strong>Ingredia Nutrisha,</strong> A collection of textile samples lay spread
                                       out on the table - Samsa was a travelling salesman - and above it there hung a
                                       picture
                                    </p>
                                    <p className="mb-2">
                                       Even the all-powerful Pointing has no control about the blind texts it is an
                                       almost unorthographic life One day however a small line of blind text by the name
                                       of Lorem Ipsum decided to leave for the far World of Grammar. Aenean vulputate
