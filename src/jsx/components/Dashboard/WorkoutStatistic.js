...
const ApexLine3 = loadable(() => pMinDelay(import('../charts/apexcharts/Line3'), 500));
const ApexLine = loadable(() => pMinDelay(import('../charts/apexcharts/Line'), 500));
const ApexLine2 = loadable(() => pMinDelay(import('../charts/apexcharts/Line2'), 500));
const ApexPie = loadable(() => pMinDelay(import('../charts/apexcharts/Pie'), 500));
                  ...
                  <div className="col-xl-12">
                     <div className="card">
                        <div className="card-body p-0">
                           ...
                           {/* Modal */}
                           <Modal show={activeModal} className="fade" id="addMoreTraining">
                              <div className="modal-content">
                                 <Modal.Header className="modal-header">
                                    <Modal.Title className="modal-title">Add more training</Modal.Title>
                                    <Button
                                       variant=""
                  ...
                  <div className="col-xl-12 col-md-6">
                     <div className="card">
                        <div className="card-header flex-wrap border-0 pb-0">
                           ...
                           <Link to="/personal-record" className="btn btn-outline-light btn-rounded">
                              Set Target
                           </Link>
                        </div>
