                  ...
                  <div className="col-xl-12">
                     <div className="card">
                        <div className="card-header d-sm-flex d-block pb-0 border-0">
                           ...
                           <Link to="/diet-food-menu" className="btn rounded text-black border border-light">
                              <svg
                                 width={25}
                                 height={24}
                                 viewBox="0 0 25 24"
                        ...
                        >
                           {data.map((d, i) => (
                              <div className="media mb-3 pb-3 d-md-flex d-block menu-list" key={i}>
                                 <ModalContent
                                    active={activesigleMenu === i}
                                    onClick={() => setActivesigleMenu(false)}
                                 />
                                 <Link to="ecom-product-detail.html">
                                    <img className="rounded mr-3 mb-md-0 mb-3" src={d.img} alt width={130} />
                                 </Link>
                                 <div className="media-body col-lg-6 pl-0">
                                    <div className="d-flex mb-3 align-items-center">
                                       <img src={d.author.img} alt width={30} className="rounded-circle mr-2" />
                                       <span className="fs-14 text-black font-w500">{d.author.name}</span>
                                    </div>
                                    <h6 className="fs-16 font-w600">
                                       <Link to="ecom-product-detail.html" className="text-black">
                                          {d.title}
                                       </Link>
                                    </h6>
                                    <p className="fs-14 mb-md-0 mb-3">{d.des}</p>
                                 </div>
                                 <ul className="m-md-auto mt-2 pr-4 mb-2">
                                    <li className="mb-2 text-nowrap">
                                       <i className="las la-clock scale5 mr-3" />
                                       <span className="fs-14 text-black text-nowrap font-w500">{d.time} mins </span>
                                    </li>
                                    <li className="mb-2 text-nowrap">
                                    ...
                                    <li className="text-nowrap">
                                       <i className="fa fa-star-o mr-3 scale5 text-warning" aria-hidden="true" />
                                       <span className="text-nowrap fs-14 text-black font-w500">
                                          {d.review} Reviews
                                       </span>
                                    </li>
                  ...
                  <div className="col-xl-12 col-lg-6">
                     <div className="card">
                        <div className="card-header pb-0 border-0">
                           ...
                           <ModalContent active={addDietMenu} onClick={() => setAddDietMenu(false)} />
                        </div>
                        <div className="card-body">
                           <div className="media mb-3">
                              <Link to="ecom-product-detail.html">
                                 <img src={menu08} alt className="rounded mr-3" width={86} />
                              </Link>
                           ...
                           <ul className="m-md-auto mt-2 pr-4">
                              <li className="mb-2 text-nowrap">
                                 <i className="las la-clock scale5 mr-3" />
                                 <span className="fs-14 text-black text-nowrap font-w500">4-6 mins </span>
                              </li>
                              <li className="mb-2 text-nowrap">
                                 <i className="las la-calendar-alt scale5 mr-3" />
                                 <span className="fs-14 text-black  font-w500">Breakfast (Monday, Tuesday)</span>
                              </li>
                              <li className="mb-2 text-nowrap">
                                 <i className="las la-prescription-bottle scale5 mr-3" />
                                 <span className="text-nowrap fs-14 text-primary font-w500">8 Ingridients</span>
                              </li>
                           </ul>
                        </div>
                     </div>
                     ...
                     <div className="card">
                        ...
                        >
                           <div className="media border-bottom py-3">
                              <Link to="ecom-product-detail.html">
                                 <img src={menu09} alt className="rounded mr-3" width={50} />
                              </Link>
                              ...
                              <div className="text-center">
                                 ...
                                 <span className="d-block fs-16 text-black font-w600">#1</span>
                              </div>
                           </div>
                           <div className="media border-bottom py-3">
                              <Link to="ecom-product-detail.html">
                                 <img src={menu10} alt className="rounded mr-3" width={50} />
                              </Link>
                              <div className="pr-3 mr-auto media-body">
                                 <h6 className="fs-16 font-w600 mb-0">
                                    <Link to="ecom-product-detail.html" className="text-black">
                              ...
                              <div className="text-center">
                                 ...
                                 <span className="d-block fs-16 text-black font-w600">#2</span>
                              </div>
                           </div>
                           <div className="media border-bottom py-3">
                              <Link to="ecom-product-detail.html">
                                 <img src={menu11} alt className="rounded mr-3" width={50} />
                              </Link>
                              <div className="pr-3 mr-auto media-body">
                                 <h6 className="fs-16 font-w600 mb-0">
                                    <Link to="ecom-product-detail.html" className="text-black">
                              ...
                              <div className="text-center">
                                 ...
                                 <span className="d-block fs-16 text-black font-w600">#3</span>
                              </div>
                           </div>
                           <div className="media border-bottom py-3">
                              <Link to="ecom-product-detail.html">
                                 <img src={menu12} alt className="rounded mr-3" width={50} />
                              </Link>
                              <div className="pr-3 mr-auto media-body">
                                 <h6 className="fs-16 font-w600 mb-0">
                                    <Link to="ecom-product-detail.html" className="text-black">
                              ...
                              <div className="text-center">
                                 ...
                                 <span className="d-block fs-16 text-black font-w600">#4</span>
                              </div>
                           </div>
                        </PerfectScrollbar>
                        <div className="card-footer text-center border-0 pt-3 pb-4">
                           <Link className="text-primary dz-load-more" id="TrendingIngridients" to="/ecom-product-list">
                              View more
                           </Link>
                        </div>
                     </div>
