...
const ApexLine4 = loadable(() => pMinDelay(import('../charts/apexcharts/Line4'), 500));
const ApexNagetivePosative = loadable(() => pMinDelay(import('../charts/apexcharts/NagetivePositive2'), 500));
const ApexRedialBar = loadable(() => pMinDelay(import('../charts/apexcharts/RadialBar'), 500));
...
const Home = () => {
   ...
   function SamplePrevArrow(props) {
      const { onClick } = props;
      return (
         <div className="owl-prev disabled" onClick={onClick} style={{ zIndex: 99 }}>
               ...
               <div className="card">
                  <div className="card-header flex-wrap pb-0 border-0">
                     <div className="mr-auto pr-3 mb-2">
                        ...
                        <p className="fs-13 mb-2 mb-sm-0 text-black">Lorem ipsum dolor sit amet, consectetur</p>
                     </div>
            ...
            <div className="col-xl-3 col-xxl-4 col-md-6">
               <div className="card">
                  ...
                  <div className="card-body text-center">
                     ...
                     <Link to="/workout-statistic" className="btn btn-outline-primary rounded">
                        Set Target
                     </Link>
                  </div>
               </div>
               ...
               <div className="card">
                  <Tab.Container defaultActiveKey="breakfast">
                     <div className="card-header d-sm-flex d-block pb-0 border-0">
                        ...
                        <Link to="/diet-food-menu" className="btn btn-primary rounded d-none d-lg-block ml-0 ml-md-5">
                           View More
                        </Link>
                     </div>
                              ...
                              <div className="featured-menus owl-carousel">
                                 <Slider {...settings}>
                                    <div className="items">
                                       <div className="d-sm-flex p-3 border border-light rounded">
                                          <Link to="/ecom-product-detail">
                                             <img className="mr-4 food-image rounded" src={menu03} alt="" width={160} />
                                          </Link>
                                          <div>
                                             ...
                                             <ul>
                                                <li className="mb-2">
                                                   ...
                                                   <span className="fs-14 text-black">4-6 mins </span>
                                                </li>
                                                <li>
                                                   <i
                                                      ...
                                                      aria-hidden="true"
                                                   />
                                                   <span className="fs-14 text-black font-w500">176 Reviews</span>
                                                </li>
                                             </ul>
                                          </div>
                                       </div>
                                    ...
                                    <div className="items">
                                       <div className="d-sm-flex p-3 border border-light rounded">
                                          <Link to="/ecom-product-detail">
                                             <img className="mr-4 food-image rounded" src={menu01} alt="" width={160} />
                                          </Link>
                                          <div>
                                             <div className="d-flex align-items-center mb-2">
                                                <img
                                             ...
                                             <ul>
                                                ...
                                                <li>
                                                   <i
                                                      ...
                                                      aria-hidden="true"
                                                   />
                                                   <span className="fs-14 text-black font-w500">568 Reviews</span>
                                                </li>
                                             </ul>
                                          </div>
                                       </div>
                                    ...
                                    <div className="items">
                                       <div className="d-sm-flex p-3 border border-light rounded">
                                          <Link to="/ecom-product-detail">
                                             <img className="mr-4 food-image rounded" src={menu02} alt="" width={160} />
                                          </Link>
                                          <div>
                                             <div className="d-flex align-items-center mb-2">
                                                <img
                                                   ...
                                                   width={30}
                                                />
                                                <span className="fs-14 text-primary">Chintya</span>
                                             </div>
                                             <h6 className="fs-16 mb-4">
                                                <Link to="/ecom-product-detail" className="text-black">
                                             ...
                                             <ul>
                                                ...
                                                <li>
                                                   <i
                                                      ...
                                                      aria-hidden="true"
                                                   />
                                                   <span className="fs-14 text-black font-w500">223 Reviews</span>
                                                </li>
                                             </ul>
                                          </div>
                                       </div>
