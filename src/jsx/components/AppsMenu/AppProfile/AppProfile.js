                              ...
                              >
                                 <div className="my-post-content pt-3">
                                    <div className="post-input">
                                       ...
                                       />
                                       <Link to="/app-profile" className="btn btn-primary light px-3">
                                          <i className="fa fa-link" />
                                       </Link>
                                       <Link to="/app-profile" className="btn btn-primary light mr-1 px-3 ml-1">
                                    ...
                                    <div className="profile-uoloaded-post border-bottom-1 pb-5">
                                       ...
                                       <p>
                                          ...
                                          possession of my entire soul like these sweet morning of spare which enjoy
                                          whole heart.
                                       </p>
